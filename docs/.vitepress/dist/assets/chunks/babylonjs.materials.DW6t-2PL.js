import{r as ce,c as te,g as he}from"./babylon.D3V5VH3h.js";function ve(Y,ee){for(var K=0;K<ee.length;K++){const H=ee[K];if(typeof H!="string"&&!Array.isArray(H)){for(const z in H)if(z!=="default"&&!(z in Y)){const b=Object.getOwnPropertyDescriptor(H,z);b&&Object.defineProperty(Y,z,b.get?b:{enumerable:!0,get:()=>H[z]})}}}return Object.freeze(Object.defineProperty(Y,Symbol.toStringTag,{value:"Module"}))}var fe={exports:{}};(function(Y,ee){(function(H,z){Y.exports=z(ce())})(typeof self<"u"?self:typeof te<"u"?te:te,K=>(()=>{var H={"../../../dev/materials/src/cell/cell.fragment.ts":(S,d,f)=>{f.r(d),f.d(d,{cellPixelShader:()=>g});var s=f("babylonjs/Materials/effect"),t="cellPixelShader",v=`precision highp float;uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;varying vec3 vPositionW;
#ifdef NORMAL
