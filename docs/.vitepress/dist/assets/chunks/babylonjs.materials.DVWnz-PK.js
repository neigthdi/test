import{c as $}from"./commonjsHelpers.Cpj98o6Y.js";import{r as de}from"./babylon.D5PqlpCj.js";var oe={exports:{}};(function(se,ue){(function(q,Y){se.exports=Y(de())})(typeof self<"u"?self:typeof $<"u"?$:$,k=>(()=>{var q={"../../../dev/materials/src/cell/cell.fragment.ts":(S,d,f)=>{f.r(d),f.d(d,{cellPixelShader:()=>g});var s=f("babylonjs/Materials/effect"),t="cellPixelShader",m=`precision highp float;uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;varying vec3 vPositionW;
#ifdef NORMAL
...
}`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/cell/cell.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{cellVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="cellVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef NORMAL
...
#include<imageProcessingCompatibility>
#define CUSTOM_FRAGMENT_MAIN_END
}`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/fire/fire.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{fireVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="fireVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef UV1
attribute vec2 uv;
#endif
#ifdef UV2
...
#include<imageProcessingCompatibility>
#define CUSTOM_FRAGMENT_MAIN_END
}`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/fur/fur.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{furVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="furVertexShader",m=`precision highp float;attribute vec3 position;attribute vec3 normal;
#ifdef UV1
attribute vec2 uv;
#endif
#ifdef UV2
...
`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/gradient/gradient.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{gradientVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="gradientVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef NORMAL
attribute vec3 normal;
#endif
#ifdef UV1
...
`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/grid/grid.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{gridVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="gridVertexShader",m=`precision highp float;attribute vec3 position;attribute vec3 normal;
#ifdef UV1
attribute vec2 uv;
#endif
#ifdef UV2
...
#include<imageProcessingCompatibility>
#define CUSTOM_FRAGMENT_MAIN_END
}`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/lava/lava.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{lavaVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="lavaVertexShader",m=`precision highp float;uniform float time;uniform float lowFrequencySpeed;varying float noise;attribute vec3 position;
#ifdef NORMAL
attribute vec3 normal;
#endif
#ifdef UV1
...
`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/mix/mix.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{mixVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="mixVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef NORMAL
attribute vec3 normal;
#endif
#ifdef UV1
...
#include<imageProcessingCompatibility>
#define CUSTOM_FRAGMENT_MAIN_END
}`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/normal/normal.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{normalVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="normalVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef NORMAL
attribute vec3 normal;
#endif
#ifdef UV1
...
#include<imageProcessingCompatibility>
#define CUSTOM_FRAGMENT_MAIN_END
}`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/shadowOnly/shadowOnly.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{shadowOnlyVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="shadowOnlyVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef NORMAL
attribute vec3 normal;
#endif
#include<bonesDeclaration>
...
#include<imageProcessingCompatibility>
#define CUSTOM_FRAGMENT_MAIN_END
}`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/simple/simple.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{simpleVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="simpleVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef NORMAL
attribute vec3 normal;
#endif
#ifdef UV1
...
`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/sky/sky.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{skyVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="skyVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef VERTEXCOLOR
attribute vec4 color;
#endif
...
`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/terrain/terrain.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{terrainVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="terrainVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef NORMAL
attribute vec3 normal;
#endif
#ifdef UV1
...
`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/triPlanar/triplanar.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{triplanarVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="triplanarVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef NORMAL
attribute vec3 normal;
#endif
#ifdef VERTEXCOLOR
...
`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/water/index.ts":(S,d,f)=>{f.r(d),f.d(d,{WaterMaterial:()=>s.WaterMaterial});var s=f("../../../dev/materials/src/water/waterMaterial.ts")},"../../../dev/materials/src/water/water.fragment.ts":(S,d,f)=>{f.r(d),f.d(d,{waterPixelShader:()=>g});var s=f("babylonjs/Materials/effect"),t="waterPixelShader",m=`#ifdef LOGARITHMICDEPTH
#extension GL_EXT_frag_depth : enable
#endif
...
`;s.ShaderStore.ShadersStore[t]=m;var g={name:t,shader:m}},"../../../dev/materials/src/water/water.vertex.ts":(S,d,f)=>{f.r(d),f.d(d,{waterVertexShader:()=>g});var s=f("babylonjs/Materials/effect"),t="waterVertexShader",m=`precision highp float;attribute vec3 position;
#ifdef NORMAL
attribute vec3 normal;
#endif
#ifdef UV1
